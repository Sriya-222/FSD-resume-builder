    ...
    <div className="min-h-[297mm] bg-white print:min-h-0">
      ...
      {resumeData.personalInfo?.photo && (
        <div className="text-center py-6 bg-gray-50">
          <img 
            ...
            alt="Profile" 
            className="w-28 h-28 rounded-full mx-auto object-cover border-4 border-green-500 shadow-lg"
          />
        </div>
      )}
      ...
      <div className="p-8">
        <div className="text-center mb-8 overflow-hidden">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-600 px-4 break-words">
              ...
              <SectionRenderer title="Projects" design={sectionDesign} colors={colors} icon={<FaProjectDiagram className="text-xl" />}>
                {resumeData.projects.map((project, index) => (
                  <div key={index} className="mb-4 break-inside-avoid">
                    ...
                    {project.description && (
                      <div 
                        className="text-sm text-gray-700 prose prose-sm max-w-none mb-2"
